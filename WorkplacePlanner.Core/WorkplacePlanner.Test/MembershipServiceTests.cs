    ...
    public class MembershipServiceTests
    {
        ...
        private static List<ApplicationUser> GetUsers()
        {
            var list = new List<ApplicationUser> {
                ...
                CreateUser(4, "Steve", "Smith", false, "steve@yopmail.com"),
                ...
                CreateUser(100, "Sauron", "Khan", true, "Sauron@yopmail.com"),
                CreateUser(101, "Prodo", "Kapoor", true, "Prodo@yopmail.com"),
                CreateUser(102, "Bilbo", "Baggins", true, "Bilbo@yopmail.com"),
                CreateUser(103, "Piping", "Monro", true, "Piping@yopmail.com")
            };
